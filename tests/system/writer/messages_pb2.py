...
# source: tests/system/writer/messages.proto
...
_SIMPLEMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='SimpleMessage.value', index=1,
...
SimpleMessage = _reflection.GeneratedProtocolMessageType('SimpleMessage', (_message.Message,), {
  ...
  '__module__' : 'tests.system.writer.messages_pb2'
